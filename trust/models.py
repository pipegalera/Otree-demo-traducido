...
class Player(BasePlayer):
    ...
    training_answer_x = models.CurrencyField(verbose_name='El participante A tendría')
    training_answer_y = models.CurrencyField(verbose_name='El participante B tendría')
